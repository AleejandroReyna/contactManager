...
var users_model_1 = require("../../data/users.model");
var router = express_1.default.Router();
exports.default = router;
//Peticiones segun el standar RESTfull
//Find: obtiene todos los elementos de la collecion tasks
router.get('/', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var usersElements, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, users_model_1.users.find(req.query).exec()];
            case 1:
                usersElements = _a.sent();
...
router.get('/:id', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var userElement, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, users_model_1.users
                        .findOne({
                        _id: req.params.id,
                    })
                        .exec()];
...
router.post('/', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var userElement, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, users_model_1.users.create(req.body)];
            case 1:
                userElement = _a.sent();
...
router.put('/:id', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, users_model_1.users.updateOne({
                        _id: req.params.id
                    }, req.body).exec()];
            case 1:
                _a.sent();
...
router.delete('/:id', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, users_model_1.users.deleteOne({
                        _id: req.params.id
                    }).exec()];
            case 1:
                _a.sent();
