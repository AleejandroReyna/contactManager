...
var contacts_model_1 = require("../../data/contacts.model");
var router = express_1.default.Router();
exports.default = router;
//Peticiones segun el standar RESTfull
//Find: obtiene todos los elementos de la collecion tasks
router.get('/', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var contactsElements, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, contacts_model_1.contacts.find(req.query).exec()];
            case 1:
                contactsElements = _a.sent();
...
router.get('/:id', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var contactsElements, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, contacts_model_1.contacts
                        .findOne({
                        _id: req.params.id,
                    })
                        .exec()];
...
router.post('/', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var contactsElements, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, contacts_model_1.contacts.create(req.body)];
            case 1:
                contactsElements = _a.sent();
...
router.put('/:id', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, contacts_model_1.contacts.updateOne({
                        _id: req.params.id
                    }, req.body).exec()];
            case 1:
                _a.sent();
...
router.delete('/:id', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, contacts_model_1.contacts.deleteOne({
                        _id: req.params.id
                    }).exec()];
            case 1:
                _a.sent();
